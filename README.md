...
**Business Data Analyst | MSc Big Data Analytics Student**

I’m a Business Data Analyst with a background in business data analytics and a focus on **data visualization, spatial analysis, machine learning, and applied analytics**. I enjoy working with complex datasets and turning them into clear, meaningful insights that support better decisions.

Currently, I work as a **Data Analyst in the financial services industry**, where I build SQL queries, develop reporting solutions, and work with production data systems. My work includes creating, refactoring, and maintaining SQL queries across evolving data environments.


I’m also pursuing an **MSc in Big Data Analytics at San Diego State University**, where my work has expanded into machine learning, GIS, spatial analysis, and community-focused data projects.

**Technical Skills**
SQL · Tableau · Excel · Python · R · ArcGIS · Pandas · Scikit-learn

**Areas of Interest**
Data Visualization · Spatial Analysis · Machine Learning · Data Storytelling · Applied Analytics

[![LinkedIn](https://img.shields.io/badge/LinkedIn-Connect-blue?style=flat-square\&logo=linkedin)](https://www.linkedin.com/in/-amygaffney/)
